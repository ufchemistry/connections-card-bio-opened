<?php
/**
 * Plugin Name:       Connections Bio Entry Opened - Template
...
if ( ! class_exists( 'CN_Bio_Card_Opened_Template' ) ) {

	class CN_Bio_Card_Opened_Template {

		public static function register() {

			$atts = array(
				'class'       => 'CN_Bio_Card_Opened_Template',
				'name'        => 'Bio Entry Opened Card',
				'slug'        => 'card-bio-opened',
				'type'        => 'all',
				'version'     => '2.0.1',
...
<p class="clearfloat"></p>
			...
			<div class="cn-entry" style="-moz-border-radius:4px; background-color:#FFFFFF; border:1px solid #E3E3E3; color: #000000; margin:8px 0px; padding:6px; position: relative; width:100%">
...
?>
	...
	add_action( 'cn_register_template', array( 'CN_Bio_Card_Opened_Template', 'register' ) );
}
